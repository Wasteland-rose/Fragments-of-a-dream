    ...
    $("#TextContents").html(
        ...
        '<div class="content ShortStory AllAges Serious Love">' +
            '<div class="Blu">' +
                ...
                '<div class="Writing_Blu">執筆日：2025/04/29</div>' +
                '<div class="Plot_Blu"><a href="main/plot/moonlit_night.html">プロットはこちら</a></div>' +
            '</div>' +
        '</div>' +
    					/*---------------*/
        '<div class="content LongStory R15 Drama Horror">' +
            '<div class="Bla">' +
                '<div class="Title_Bla"><a href="main/nonfiction-horror.html">言葉は要らず</a></div>' +
