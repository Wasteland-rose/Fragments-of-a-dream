		...
		'<div id="index-image">' + '<img src="images/index.png">' + '</div>' +
			'<div id="index-text-content">' +
				'<ul>' +
					...
					'<li>' + 'ホーム画面に追加する場合、LINKS内にある「SHORTCUT ICON」から追加してください。<BR />※できない場合もあります。' + '</li>' +
				'</ul>' +
			'</div>'
	);
});
		...
		'<dl>' +
			...
			'<dt>' + 'FREE' + '</dt>' +
				'<dd>' +
					...
					'<a href="http://jp.freepik.com/free-psd/cracked-surface-texture-black-cracks-white-background-abstract-design-element_411795093.htm#fromView=keyword&page=1&position=2&uuid=4c74c26d-863c-472f-91f1-c3462b6ca15f&query=%E5%89%B2%E3%82%8C%E3%82%8B+Png" target="_blank">割れる画像</a>' + '<BR />' +
				'</dd>' +
		'</dl>'
	);
});
